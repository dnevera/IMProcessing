Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://bitbucket.org/degrader/improcessing.git', :tag => '0.2.1'}
  ...
  s.frameworks   = 'Metal'
  s.xcconfig     =   { 'OTHER_LDFLAGS' => '/opt/libjpeg-turbo/lib/libturbojpeg.a', 'MTL_HEADER_SEARCH_PATHS' => '$(MTL_HEADER_SEARCH_PATHS) $(PODS_ROOT)/Headers/Private/IMProcessing'}
